...
// Wine API hooks
	...
	app.route('/api/wines/name/:wineName')
		...
		.patch(wineCtrl.edit_wine_by_name)
	...
	app.route('/api/wines/:wineId')
		...
		.patch(wineCtrl.edit_wine_by_ID)
		.delete(wineCtrl.delete_wine_by_ID);

	app.route('/api/wineMatch/food/:wineType')
		.get(wineCtrl.wine_pairs_food);
